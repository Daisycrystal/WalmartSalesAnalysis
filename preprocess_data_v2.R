...
results <- with(dfAll,
                by(data=dfAll,
                   ...
                   FUN=function(df)sapply(df$Day_Index[df$Day_Index<=143],
                                          function(d)func1(d, df, offset=51))))
...
results <- with(dfAll,
                by(data=dfAll,
                   INDICES=list(Store, Dept),
                   FUN=function(df)sapply(df$Day_Index[df$Day_Index<=143],
                                          function(d)func1(d, df, offset=52))))
results <- unlist(results)
...
results <- with(dfAll,
                by(data=dfAll,
                   INDICES=list(Store, Dept),
                   FUN=function(df)sapply(df$Day_Index[df$Day_Index<=143],
                                          function(d)func1(d, df, offset=53))))
results <- unlist(results)
...
save(list=c('dfTrain', 'dfTest', 'testID', 'dfSampleSubmission'),
     file='./data/saurabh_workspace.RData')
